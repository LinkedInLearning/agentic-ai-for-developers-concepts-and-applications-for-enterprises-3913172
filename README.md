...
This repo now includes a Google Gemini example. Users can use Google as the LLM backend
without interfering with Azure setups.

Use this file "code_03_XX A basic Agent - Router application_google_gemini.ipynb"
